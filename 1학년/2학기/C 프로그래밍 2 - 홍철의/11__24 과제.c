...
int main(void)
{
	...
	printf("교통수단: %s,", get_aop(traffics_aop, traffic_num, char_num, &ch));
	printf("문자: %c\n", ch);

	//아래를 완성하시오. get_poa()를 호출하시오.

	printf("교통수단: %s,", get_poa(traffics_poa, traffic_num, char_num, &ch));
	printf("문자: %c\n", ch);
...
정수 계산식: 5-2
5-2 = 3
C:\Users\rlawl\OneDrive\바탕 화면\C code\Project1\x64\Debug\Project1.exe(프로세스 49056개)이(가) 종료되었습니다(코드: 0 개).
